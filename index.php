...
<html lang="zxx">
   ...
   <body>
      ...
      <section class="blog py-lg-4 py-md-3 py-sm-3 py-3">
         ...
         <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3" id="title" >New Arrivals</h3>
            <div class="slid-img">
               <ul id="flexiselDemo1">
                  <?php
$ret=pg_query($con,"select tblarttype.id as atid,tblarttype.arttype as typename,tblartproduct.id as apid,tblartproduct.title,tblartproduct.image,tblartproduct.arttype from tblartproduct join tblarttype on tblarttype.id=tblartproduct.arttype");
$cnt=1;
...
?>
                  <li>
                     ...
                     <div class="agileinfo_port_grid">
                        ...
                        <div class="outs_more-buttn">
                           <a href="admin/login.php?eid=<?php echo $row['apid'];?>">Enquiry</a>
                           <a href="admin/login.php?eid=<?php echo $row['apid'];?>">Buy</a>
                        </div>
                     </div>
                  </li><?php }?>
