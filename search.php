...
$ret=pg_query($con,"select tblarttype.id as atid,tblarttype.arttype as typename,tblartproduct.id as apid,tblartproduct.title,tblartproduct.image,tblartproduct.arttype from tblartproduct join tblarttype on tblarttype.id=tblartproduct.arttype where tblartproduct.title ilike '%$searchinput%'");
$cnt=1;
